...
public:
  ...
  void set_center_waypoint(const geometry_msgs::msg::PointStamped::SharedPtr& msg);
  ...
  geometry_msgs::msg::PointStamped::SharedPtr get_center_waypoint() const;
...
private:
  ...
  geometry_msgs::msg::PointStamped::SharedPtr center_waypoint_;
