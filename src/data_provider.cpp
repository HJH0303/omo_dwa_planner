...
void DataProvider::set_center_waypoint(const geometry_msgs::msg::PointStamped::SharedPtr& msg)
{
  std::lock_guard<std::mutex> lk(mtx_);
  center_waypoint_ = msg;
}
...
geometry_msgs::msg::PointStamped::SharedPtr DataProvider::get_center_waypoint() const
{
  std::lock_guard<std::mutex> lk(mtx_);
  return center_waypoint_;
}
