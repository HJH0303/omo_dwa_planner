...
DwaNodeImpl::DwaNodeImpl() : rclcpp::Node("dwa_node")
{
  ...
  wpc_sub_ = this->create_subscription<geometry_msgs::msg::PointStamped>(
      "/target_center_point", 10,
      std::bind(&DwaNodeImpl::wpc_cb, this, std::placeholders::_1));
...
void DwaNodeImpl::timer_cb()
{
  ...
  Pose2D local_center_goal{wpc->point.x, wpc->point.y, 0.0};
